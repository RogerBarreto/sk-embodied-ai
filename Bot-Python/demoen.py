...
MENU_ITEMS = [
    ...
    ("skai", "19vision","skai",la['DEMOEN']['SKAI'])
]
    ...
    if (key_state_down == 1):
        try:
            ...
            if MENU_ITEMS[MENU_CURRENT_SELECT][2]=="dog_show":
                ...
                os.system('sudo python3 ./demos/language.py')
            ...
            elif MENU_ITEMS[MENU_CURRENT_SELECT][2]=="skai":
                os.system('python3 /home/pi/ai-dog/main.py')
            print('program done')
            draw_title_bar(MENU_CURRENT_SELECT)        
